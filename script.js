...
<div style="position: relative; width: 100%; height: 100%;">
    ...
    // ═══════════════════════════════════════════════════════════════════════════════
    /**
     * Export vers le format .psmd (PrintShop Mail XML).
     * 
     * La génération XML est déléguée au module externe PsmdGenerator (psmd-generator.js).
     * Cette section contient uniquement les fonctions qui nécessitent le DOM.
     * 
     * Fonctions de conversion couleur :
     *   - rgbToCmyk() : Conversion RGB hex → CMYK
     *   - cmykToHex() : Conversion CMYK → RGB hex
     *   - cmjnWebDevToHex() : Conversion CMJN WebDev → hex
     *   - hexToCmjnWebDev() : Conversion hex → CMJN WebDev
     * 
     * Fonctions UI CMJN (toolbars) :
     *   - updateCmjnFieldsFromHex() : Met à jour les champs C/M/J/N
     *   - getHexFromCmjnFields() : Lit les champs et retourne hex
     *   - getCmjnValuesFromFields() : Lit les champs et retourne CMJN
     *   - initCmjnFieldsListeners() : Initialise les listeners CMJN
     * 
     * Fonctions de vérification pré-export :
     *   - checkDocumentIntegrity() : Vérifie l'intégrité du document
     *   - showCheckResult() : Affiche le résultat de la vérification
     *   - showCheckErrorsModal() : Affiche la modale d'erreurs
     *   - hideCheckModal() : Ferme la modale
     * 
     * Fonctions d'export :
     *   - downloadImageFromBase64() : Télécharge une image (DOM)
     *   - exportToPsmd() : Orchestre l'export via PsmdGenerator
     */
    // ───────────────────────────────────────────────────────────────────────────────
