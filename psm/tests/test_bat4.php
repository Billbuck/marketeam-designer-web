...
$psmdFile = 'C:\Test Designer Printshop\test.psmd';
$outputFile = $_SERVER['DOCUMENT_ROOT'] . '/psm/bat_output.jpg';
...
if ($jpegStart !== false) {
    ...
    echo "<h2>Image :</h2>";
    echo '<img src="bat_output.jpg?' . time() . '" style="max-width:100%; border:1px solid black;" />';
} else {
